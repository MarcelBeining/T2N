%% *T2N Tutorial*
% *This script is to show you some applications of t2n. the first section initializes 
% the morphology and standard parameters, whereas the other sections define the 
...
% of distributed mechanisms orother cell-specific parameters (e.g. voltage) can 
...
% excitatory cell and and returns somatic inhibition. We also added a line that 
